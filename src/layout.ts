...
// Happy Birthday To Me. 09.27.2019
...
export function attribute<T>(c: IAttributeConstrucor, o: IAttrOptions): IAttributeInterface{
    return new c(o);
}

export function element(c: IElementConstructor, o: IElementOptions): IElementInterface{
...
export interface MeiAbstracFactory {
    createElement(c: IElementConstructor, o: IElementOptions): IElementInterface;
    createAttr(c: IAttributeConstrucor, o: IAttrOptions): IAttributeInterface;
}

...
export class MeiDoc implements IMeiDoc{
   root: IRootNode;
   public constructor(root: IRootNode){
       this.root = root
   }
...
export interface INode {
    ...
    position: IPosition;
    children: NodeArray<INode>;
    attribute: Array<MeiToken>;

    element: layout.IElementInterface;
}


export interface NodeArray<T extends INode> extends ReadonlyArray<T> {}
